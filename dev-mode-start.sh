...
# Ini adalah cara yang BENAR untuk menjalankan Spring Boot di development mode
# dengan auto-reload untuk HTML/JS/CSS
...
# Run dengan spring-boot:run (NOT java -jar)
mvn spring-boot:run
